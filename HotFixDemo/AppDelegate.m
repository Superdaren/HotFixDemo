...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    fixInstanceMethodReplace('CrashTest', 'divideUsingDenominator:', function(instance, originInvocation, originArguments){\
    ...
    [HotFixTool evalString:fixScriptString];
    
    CrashTest *mc = [[CrashTest alloc] init];
